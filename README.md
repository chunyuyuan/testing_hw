...
- It provides domain-specific representations for histopathology, outperforming general-purpose backbones (e.g., ResNet, Swin Transformer) on cell-level tasks.
